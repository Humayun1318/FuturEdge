      ...
      <section className="w-11/12 mx-auto py-24">
        <div className="flex flex-col lg:flex-row items-center gap-6">
          <div className="space-y-4">
            ...
            <h1 className="font-lora-heading text-3xl lg:text-5xl font-extrabold">
            ...
            <p className="text-gray-600">
              <span className="text-lg font-semibold">FuturEdge:</span>{" "}
              Nurturing Your Potential, Shaping Your Future
            </p>
          </div>
